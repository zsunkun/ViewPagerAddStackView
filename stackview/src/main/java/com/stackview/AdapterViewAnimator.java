...
public abstract class AdapterViewAnimator extends AdapterView<Adapter>
    ...
    public AdapterViewAnimator(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int resource = a.getResourceId(
                R.styleable.AdapterViewAnimator_inAnimationHorizontal, 0);
        if (resource > 0) {
        ...
        resource = a.getResourceId(R.styleable.AdapterViewAnimator_outAnimationHorizontal, 0);
        if (resource > 0) {
        ...
        boolean flag = a.getBoolean(
                R.styleable.AdapterViewAnimator_animateFirstViewHorizontal, true);
        setAnimateFirstView(flag);

        mLoopViews = a.getBoolean(
                R.styleable.AdapterViewAnimator_loopViewsHorizontal, false);
